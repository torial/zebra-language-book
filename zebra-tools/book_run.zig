...
// Source: C:/Projects/zebra-language-book/zebra-tools/book_run.zbr
...
pub const Walker = struct {
    _type_tag: u64 = _ttag_Walker,
    files: std.ArrayList([]const u8) = undefined,
    pub fn init() *Walker {
        const self = _allocator.create(Walker) catch @panic("OOM");
        self._type_tag = _ttag_Walker;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:43
        self.files = std.ArrayList([]const u8){};
        return self;
    }

    pub fn collect(self: *Walker, root: []const u8) void {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:46
        self.descend(root);
    }

    pub fn descend(self: *Walker, path: []const u8) void {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:49
        const entries: std.ArrayList([]const u8) = (blk: {
            var _ld_dir = std.fs.cwd().openDir(path, .{ .iterate = true }) catch @panic("File.listDir error");
            defer _ld_dir.close();
...
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:50
        for (entries.items) |name| {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:51
            if (std.mem.startsWith(u8, name, ".")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:53
            if (std.mem.eql(u8, name, "node_modules")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:55
            if (std.mem.eql(u8, name, "zebra-tools")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:60
            if (std.mem.eql(u8, name, "PATTERNS-Common-Tasks.md")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:62
            if (std.mem.eql(u8, name, "PROJECT_STATUS.md")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:64
            if (std.mem.eql(u8, name, "QUICKSTART-30-Minutes.md")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:66
            if (std.mem.eql(u8, name, "README.md")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:68
            if (std.mem.startsWith(u8, name, "_BOOK_")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:70
            if (std.mem.startsWith(u8, name, "COMPLETION_")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:72
            if (std.mem.startsWith(u8, name, "CRITICAL_")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:74
            if (std.mem.eql(u8, name, "BOOK_COMPLETION_STATUS.md")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:76
            if (std.mem.eql(u8, name, "BUILD_PDF_README.md")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:78
            if (std.mem.eql(u8, name, "BUILD_SYSTEM_STATUS.md")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:80
            if (std.mem.eql(u8, name, "BUILD_WITH_PNG_DIAGRAMS.md")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:82
            if (std.mem.eql(u8, name, "CHEATSHEET-Syntax.md")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:84
            if (std.mem.eql(u8, name, "CONTRIBUTING.md")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:86
            if (((std.mem.eql(u8, name, "_outline.md") or std.mem.eql(u8, name, "_WRITING_STATUS.md")) or std.mem.eql(u8, name, "_CHAPTER_COUNT.txt"))) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:88
            const full = Walker.joinPath(path, name);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:89
            if ((blk: { var _de_d = std.fs.cwd().openDir(full, .{}) catch break :blk false; _de_d.close(); break :blk true; })) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:90
                self.descend(full);
            } else if (std.mem.endsWith(u8, name, ".md")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:92
                self.files.append(_allocator, _intern(full)) catch unreachable;
            }
        }
    }

    pub fn joinPath(a: []const u8, b: []const u8) []const u8 {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:95
        if (std.mem.endsWith(u8, a, "/")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:96
            return _str_concat(a, b, _allocator);
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:97
        if (std.mem.endsWith(u8, a, "\\")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:98
            return _str_concat(a, b, _allocator);
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:99
        return _str_concat(_str_concat(a, "/", _allocator), b, _allocator);
    }

};

const _ttag_Walker: u64 = 525121415;
const _reflect_Walker_name: []const u8 = "Walker";
const _reflect_Walker_fields: []const []const u8 = &.{"files"};
const _reflect_Walker_field_types: []const []const u8 = &.{"List(str)"};

pub const Result = struct {
    file: []const u8 = undefined,
    block_no: i64 = undefined,
    start_line: i64 = undefined,
    status: []const u8 = undefined,
    note: []const u8 = undefined,
    pub fn init(file: []const u8, block_no: i64, start_line: i64, status: []const u8, note: []const u8) Result {
        var self: Result = undefined;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:110
        self.file = _intern(file);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:111
        self.block_no = block_no;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:112
        self.start_line = start_line;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:113
        self.status = _intern(status);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:114
        self.note = _intern(note);
        return self;
    }
...
pub const Runner = struct {
    ...
    zebra_bin: []const u8 = undefined,
    tmp_dir: []const u8 = undefined,
    results: std.ArrayList(Result) = undefined,
    n_pass: i64 = 0,
    n_fail: i64 = 0,
    n_skip: i64 = 0,
    n_snippet: i64 = 0,
    pub fn init(zebra_bin: []const u8, tmp_dir: []const u8) *Runner {
        const self = _allocator.create(Runner) catch @panic("OOM");
        self._type_tag = _ttag_Runner;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:129
        self.zebra_bin = _intern(zebra_bin);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:130
        self.tmp_dir = _intern(tmp_dir);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:131
        self.results = std.ArrayList(Result){};
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:134
        self.n_pass = 0;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:135
        self.n_fail = 0;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:136
        self.n_skip = 0;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:137
        self.n_snippet = 0;
        return self;
    }

    pub fn run(self: *Runner, path: []const u8) void {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:140
        const content: []const u8 = (std.fs.cwd().readFileAlloc(_allocator, path, std.math.maxInt(usize)) catch @panic("File.read error"));
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:141
        var line_no: i64 = 0;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:142
        var in_zebra: bool = false;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:143
        var block_no: i64 = 0;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:144
        var block_start_line: i64 = 0;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:145
        var block_buf: []const u8 = "";
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:146
        var pending_skip: []const u8 = "";
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:147
        var _it_raw = std.mem.splitSequence(u8, content, "\n");
        while (_it_raw.next()) |raw| {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:148
            line_no = (line_no + 1);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:149
            if ((!in_zebra)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:151
                const trim = std.mem.trim(u8, raw, &std.ascii.whitespace);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:152
                if (std.mem.startsWith(u8, trim, "<!-- book_run: skip")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:153
                    pending_skip = Runner.parseSkipReason(trim);
                    continue;
                }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:155
                if (std.mem.startsWith(u8, raw, "```zebra")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:156
                    in_zebra = true;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:157
                    block_no = (block_no + 1);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:158
                    block_start_line = (line_no + 1);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:159
                    block_buf = "";
                    continue;
                }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:162
                if ((_zebra_gt(trim.len, 0) and (!std.mem.startsWith(u8, trim, "<!--")))) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:163
                    pending_skip = "";
                }
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:165
            if (std.mem.startsWith(u8, raw, "```")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:166
                in_zebra = false;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:167
                if (!std.mem.eql(u8, pending_skip, "")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:168
                    self.results.append(_allocator, Result.init(path, block_no, block_start_line, "skip", pending_skip)) catch unreachable;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:169
                    self.n_skip = (self.n_skip + 1);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:170
                    pending_skip = "";
                } else if ((!Runner.isCompleteProgram(block_buf))) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:175
                    self.results.append(_allocator, Result.init(path, block_no, block_start_line, "snippet", "illustrative fragment")) catch unreachable;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:176
                    self.n_snippet = (self.n_snippet + 1);
                } else {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:178
                    const status_pair = self.compileBlock(path, block_no, block_start_line, block_buf);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:179
                    const st: []const u8 = status_pair.items[@as(usize, @intCast(0))];
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:180
                    const note: []const u8 = status_pair.items[@as(usize, @intCast(1))];
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:181
                    self.results.append(_allocator, Result.init(path, block_no, block_start_line, st, note)) catch unreachable;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:182
                    if (std.mem.eql(u8, st, "pass")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:183
                        self.n_pass = (self.n_pass + 1);
                    } else {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:185
                        self.n_fail = (self.n_fail + 1);
                    }
                }
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:187
            block_buf = _str_concat(_str_concat(block_buf, raw, _allocator), "\n", _allocator);
        }
    }

    pub fn isCompleteProgram(body: []const u8) bool {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:195
        var _it_raw = std.mem.splitSequence(u8, body, "\n");
        while (_it_raw.next()) |raw| {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:196
            const line: []const u8 = std.mem.trim(u8, raw, &std.ascii.whitespace);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:197
            if ((line.len == 0)) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:199
            if (std.mem.startsWith(u8, line, "#")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:203
            const first_word = Runner.firstWord(line);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:204
            if (((std.mem.eql(u8, first_word, "def") or std.mem.eql(u8, first_word, "class")) or std.mem.eql(u8, first_word, "struct"))) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:205
                return true;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:206
            if (((std.mem.eql(u8, first_word, "union") or std.mem.eql(u8, first_word, "enum")) or std.mem.eql(u8, first_word, "interface"))) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:207
                return true;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:208
            if (((std.mem.eql(u8, first_word, "mixin") or std.mem.eql(u8, first_word, "extend")) or std.mem.eql(u8, first_word, "use"))) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:209
                return true;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:210
            if (((std.mem.eql(u8, first_word, "namespace") or std.mem.eql(u8, first_word, "sig")) or std.mem.eql(u8, first_word, "aspect"))) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:211
                return true;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:213
            if (((std.mem.eql(u8, first_word, "public") or std.mem.eql(u8, first_word, "private")) or std.mem.eql(u8, first_word, "protected"))) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:214
                return true;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:215
            if (((std.mem.eql(u8, first_word, "internal") or std.mem.eql(u8, first_word, "abstract")) or std.mem.eql(u8, first_word, "static"))) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:216
                return true;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:217
            if ((std.mem.eql(u8, first_word, "readonly") or std.mem.eql(u8, first_word, "extern"))) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:218
                return true;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:220
            if (std.mem.startsWith(u8, line, "@")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:221
                return true;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:224
            return false;
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:225
        return false;
    }

    pub fn firstWord(line: []const u8) []const u8 {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:228
        var i: i64 = 0;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:229
        const n = line.len;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:230
        while (_zebra_lt(i, n)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:231
            const c = line[@intCast(i)];
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:232
            if ((((c == ' ') or (c == '\t')) or (c == '('))) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:233
                return line[@intCast(0)..@intCast(i)];
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:234
            i = (i + 1);
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:235
        return line;
    }

    pub fn parseSkipReason(line: []const u8) []const u8 {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:240
        const prefix = "<!-- book_run: skip";
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:241
        const suffix = "-->";
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:242
        if ((!std.mem.startsWith(u8, line, prefix))) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:243
            return "(no reason)";
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:246
        var rest: []const u8 = line[@intCast(prefix.len)..@intCast(line.len)];
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:248
        if (std.mem.endsWith(u8, rest, suffix)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:249
            rest = rest[@intCast(0)..@intCast((rest.len - suffix.len))];
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:250
        const trimmed: []const u8 = std.mem.trim(u8, rest, &std.ascii.whitespace);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:251
        if ((trimmed.len == 0)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:252
            return "(no reason)";
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:253
        return trimmed;
    }

    pub fn compileBlock(self: *Runner, src: []const u8, block_no: i64, start_line: i64, body: []const u8) std.ArrayList([]const u8) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:257
        const bn: []const u8 = (std.fmt.allocPrint(_allocator, "{}", .{block_no}) catch unreachable);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:258
        const ln: []const u8 = (std.fmt.allocPrint(_allocator, "{}", .{start_line}) catch unreachable);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:259
        const stem: []const u8 = Runner.flatStem(src);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:260
        const name: []const u8 = _str_concat(_str_concat(_str_concat(_str_concat(_str_concat(stem, "__b", _allocator), bn, _allocator), "__line", _allocator), ln, _allocator), ".zbr", _allocator);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:261
        const tmp_path: []const u8 = Runner.joinPath(self.tmp_dir, name);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:262
        const header: []const u8 = _str_concat(_str_concat(_str_concat(_str_concat(_str_concat(_str_concat("# extracted from ", src, _allocator), ":", _allocator), ln, _allocator), " (block ", _allocator), bn, _allocator), ")\n", _allocator);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:263
        (std.fs.cwd().writeFile(.{ .sub_path = tmp_path, .data = _str_concat(header, body, _allocator) }) catch @panic("File.write error"));
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:268
        const cmd: []const u8 = _str_concat(_str_concat(self.zebra_bin, " --emit-zig ", _allocator), tmp_path, _allocator);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:269
...
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:271
        var out = std.ArrayList([]const u8){};
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:272
        if (_zebra_in("error:", output)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:273
            out.append(_allocator, _intern("fail")) catch unreachable;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:274
            out.append(_allocator, _intern(Runner.firstErrorLine(output))) catch unreachable;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:275
            return out;
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:280
        if (std.mem.startsWith(u8, output, "// Generated")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:281
            out.append(_allocator, _intern("pass")) catch unreachable;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:282
            out.append(_allocator, _intern("")) catch unreachable;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:283
            return out;
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:284
        if ((_zebra_in(" wrote ", output) or std.mem.startsWith(u8, output, "wrote "))) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:285
            out.append(_allocator, _intern("pass")) catch unreachable;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:286
            out.append(_allocator, _intern("")) catch unreachable;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:287
            return out;
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:289
        out.append(_allocator, _intern("fail")) catch unreachable;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:290
        out.append(_allocator, _intern(Runner.firstNonEmpty(output))) catch unreachable;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:291
        return out;
    }

    pub fn firstErrorLine(s: []const u8) []const u8 {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:294
        var _it_line = std.mem.splitSequence(u8, s, "\n");
        while (_it_line.next()) |line| {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:295
            const t: []const u8 = std.mem.trim(u8, line, &std.ascii.whitespace);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:296
            if (_zebra_in("error:", t)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:298
                if (_zebra_gt(t.len, 120)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:299
                    return _str_concat(t[@intCast(0)..@intCast(120)], "...", _allocator);
                }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:300
                return t;
            }
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:301
        return "(error not parsed)";
    }

    pub fn firstNonEmpty(s: []const u8) []const u8 {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:304
        var _it_line = std.mem.splitSequence(u8, s, "\n");
        while (_it_line.next()) |line| {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:305
            const t: []const u8 = std.mem.trim(u8, line, &std.ascii.whitespace);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:306
            if (_zebra_gt(t.len, 0)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:307
                if (_zebra_gt(t.len, 120)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:308
                    return _str_concat(t[@intCast(0)..@intCast(120)], "...", _allocator);
                }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:309
                return t;
            }
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:310
        return "(no output)";
    }

    pub fn flatStem(path: []const u8) []const u8 {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:316
        const n = path.len;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:317
        var sep_idx: i64 = (-1);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:318
        var i: i64 = 0;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:319
        while (_zebra_lt(i, n)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:320
            const c = path[@intCast(i)];
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:321
            if (((c == '/') or (c == '\\'))) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:322
                sep_idx = i;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:323
            i = (i + 1);
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:324
        var rel: []const u8 = path;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:325
        if (_zebra_ge(sep_idx, 0)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:326
            var prev_sep: i64 = (-1);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:327
            var j: i64 = 0;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:328
            while (_zebra_lt(j, sep_idx)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:329
                const c2 = path[@intCast(j)];
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:330
                if (((c2 == '/') or (c2 == '\\'))) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:331
                    prev_sep = j;
                }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:332
                j = (j + 1);
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:333
            if (_zebra_ge(prev_sep, 0)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:334
                rel = path[@intCast((prev_sep + 1))..@intCast(n)];
            } else {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:336
                rel = path[@intCast((sep_idx + 1))..@intCast(n)];
            }
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:337
        return Runner.flatten(rel);
    }

    pub fn flatten(s: []const u8) []const u8 {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:340
        var out: []const u8 = "";
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:341
        var i: i64 = 0;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:342
        const n = s.len;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:343
        while (_zebra_lt(i, n)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:344
            const c = s[@intCast(i)];
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:345
            if (((c == '/') or (c == '\\'))) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:346
                out = _str_concat(out, "__", _allocator);
            } else {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:348
                out = _str_concat(out, (blk: { var _cpbuf: [4]u8 = undefined; const _cplen = std.unicode.utf8Encode(c, &_cpbuf) catch 1; const _cpout = _allocator.dupe(u8, _cpbuf[0.._cplen]) catch @panic("OOM"); break :blk @as([]const u8, _cpout); }), _allocator);
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:349
            i = (i + 1);
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:350
        return out;
    }

    pub fn joinPath(a: []const u8, b: []const u8) []const u8 {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:353
        if (std.mem.endsWith(u8, a, "/")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:354
            return _str_concat(a, b, _allocator);
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:355
        if (std.mem.endsWith(u8, a, "\\")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:356
            return _str_concat(a, b, _allocator);
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:357
        return _str_concat(_str_concat(a, "/", _allocator), b, _allocator);
    }
...
const _reflect_Runner_fields: []const []const u8 = &.{"zebra_bin", "tmp_dir", "results", "n_pass", "n_fail", "n_skip", "n_snippet"};
const _reflect_Runner_field_types: []const []const u8 = &.{"str", "str", "List(Result)", "int", "int", "int", "int"};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:363
        const args = _arg_parse();
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:364
        const root_opt = args.positional(0);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:365
        const bin_opt = args.positional(1);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:367
        var root: []const u8 = ".";
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:368
        if (root_opt) |r| {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:369
            root = r;
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:371
        var zebra_bin: []const u8 = "../zebra-language/zig-out/bin/zebra-bootstrap.exe";
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:372
        if (bin_opt) |b| {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:373
            zebra_bin = b;
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:375
        const tmp_dir: []const u8 = "/tmp/book-run";
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:376
        (std.fs.cwd().makePath(tmp_dir) catch @panic("Dir.createAll error"));
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:378
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "[book_run] root={s}", .{root}) catch @panic("OOM"));
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:379
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "[book_run] zebra={s}", .{zebra_bin}) catch @panic("OOM"));
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:380
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "[book_run] tmp ={s}", .{tmp_dir}) catch @panic("OOM"));
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:381
        std.debug.print("{s}\n", .{"---"});
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:383
        const walker = Walker.init();
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:384
        walker.collect(root);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:385
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "[book_run] {} markdown files", .{@as(i64, @intCast(walker.files.items.len))}) catch @panic("OOM"));
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:387
        const runner = Runner.init(zebra_bin, tmp_dir);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:388
        for (walker.files.items) |f| {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:389
            const fname: []const u8 = f;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:390
            runner.run(fname);
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:394
        std.debug.print("{s}\n", .{"---"});
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:395
        var current_file: []const u8 = "";
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:396
        var all_green_in_file: bool = true;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:397
        var per_file_fail: i64 = 0;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:398
        var per_file_skip: i64 = 0;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:399
        var per_file_total: i64 = 0;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:400
        for (runner.results.items) |r| {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:401
            const rfile: []const u8 = r.file;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:402
            if (!std.mem.eql(u8, rfile, current_file)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:403
                if (!std.mem.eql(u8, current_file, "")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:404
                    if (all_green_in_file) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:405
                        {
                            const _pt0 = (std.fmt.allocPrint(_allocator, "  ({} blocks ok — pass + snippet + skip)", .{per_file_total}) catch @panic("OOM"));
                            std.debug.print("{s}\n", .{_pt0});
                        }
                    }
                }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:406
                {
                    const _pt0 = (std.fmt.allocPrint(_allocator, "{s}", .{rfile}) catch @panic("OOM"));
                    std.debug.print("{s}\n", .{_pt0});
                }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:407
                current_file = rfile;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:408
                all_green_in_file = true;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:409
                per_file_fail = 0;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:410
                per_file_skip = 0;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:411
                per_file_total = 0;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:412
            per_file_total = (per_file_total + 1);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:413
            const rstatus: []const u8 = r.status;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:414
            const rnote: []const u8 = r.note;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:415
            if (std.mem.eql(u8, rstatus, "fail")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:416
                all_green_in_file = false;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:417
                per_file_fail = (per_file_fail + 1);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:418
                {
                    const _pt0 = (std.fmt.allocPrint(_allocator, "  FAIL block {any} @ line {any}: {s}", .{r.block_no, r.start_line, rnote}) catch @panic("OOM"));
                    std.debug.print("{s}\n", .{_pt0});
                }
            } else if (std.mem.eql(u8, rstatus, "skip")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:420
                per_file_skip = (per_file_skip + 1);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:421
                {
                    const _pt0 = (std.fmt.allocPrint(_allocator, "  skip block {any} @ line {any}: {s}", .{r.block_no, r.start_line, rnote}) catch @panic("OOM"));
                    std.debug.print("{s}\n", .{_pt0});
                }
            }
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:425
        if ((!std.mem.eql(u8, current_file, "") and all_green_in_file)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:426
            {
                const _pt0 = (std.fmt.allocPrint(_allocator, "  ({} blocks ok — pass + snippet + skip)", .{per_file_total}) catch @panic("OOM"));
                std.debug.print("{s}\n", .{_pt0});
            }
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:428
        std.debug.print("{s}\n", .{"---"});
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:429
        std.debug.print("{s}\n", .{"[book_run] summary"});
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:430
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "  pass:    {}", .{runner.n_pass}) catch @panic("OOM"));
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:431
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "  fail:    {}", .{runner.n_fail}) catch @panic("OOM"));
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:432
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "  skip:    {}", .{runner.n_skip}) catch @panic("OOM"));
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:433
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "  snippet: {}", .{runner.n_snippet}) catch @panic("OOM"));
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:434
        const grand_total: i64 = (((runner.n_pass + runner.n_fail) + runner.n_skip) + runner.n_snippet);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:435
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "  total:   {}", .{grand_total}) catch @panic("OOM"));
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:436
        if (_zebra_gt(runner.n_fail, 0)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_run.zbr:437
            std.process.exit(1);
        }
    }
