...
// Source: C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr
...
pub const Finding = struct {
    _type_tag: u64 = _ttag_Finding,
    file: []const u8 = "",
    line: i64 = 0,
    category: []const u8 = "",
    text: []const u8 = "",
    pub fn init(file: []const u8, line: i64, category: []const u8, text: []const u8) *Finding {
        const _self = _allocator.create(Finding) catch @panic("OOM");
        _self._type_tag = _zbr_hash("Finding");
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:40
            _self.file = _intern(file);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:41
            _self.line = line;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:42
            _self.category = _intern(category);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:43
            _self.text = _intern(text);
        return _self;
    }

};
const _ttag_Finding: u64 = _zbr_hash("Finding");
const _reflect_Finding_name: []const u8 = "Finding";
const _reflect_Finding_fields: []const []const u8 = &.{"file", "line", "category", "text"};
const _reflect_Finding_field_types: []const []const u8 = &.{"str", "int", "str", "str"};

pub const Walker = struct {
    _type_tag: u64 = _ttag_Walker,
    files: std.ArrayList([]const u8),
    pub fn init() *Walker {
        const _self = _allocator.create(Walker) catch @panic("OOM");
        _self._type_tag = _zbr_hash("Walker");
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:51
            _self.files = std.ArrayList([]const u8){};
        return _self;
    }
...
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:58
        const entries: std.ArrayList([]const u8) = @compileError("selfhost: unknown File.listDir");
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:59
        for (entries.items) |name| {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:60
            if (std.mem.startsWith(u8, name, ".")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:62
            if (std.mem.eql(u8, name, "node_modules")) {
                continue;
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:64
            const full = Walker.joinPath(path, name);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:65
            if ((blk_de: { var _de_d = std.fs.cwd().openDir(full, .{}) catch break :blk_de false; _de_d.close(); break :blk_de true; })) {
                self.descend(full);
            } else {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:67
                if (std.mem.endsWith(u8, name, ".md")) {
                    self.files.append(_allocator, _intern(full)) catch @panic("OOM");
                }
            }
        }
    }
...
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:71
        if (std.mem.endsWith(u8, a, "/")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:72
            return _str_concat(a, b, _allocator);
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:73
        if (std.mem.endsWith(u8, a, "\\")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:74
            return _str_concat(a, b, _allocator);
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:75
        return _str_concat(_str_concat(a, "/", _allocator), b, _allocator);
    }

};
const _ttag_Walker: u64 = _zbr_hash("Walker");
...
pub const Linter = struct {
    _type_tag: u64 = _ttag_Linter,
    findings: std.ArrayList(*Finding),
    pub fn init() *Linter {
        const _self = _allocator.create(Linter) catch @panic("OOM");
        _self._type_tag = _zbr_hash("Linter");
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:83
            _self.findings = std.ArrayList(Finding){};
        return _self;
    }

    pub fn lint(self: *Linter, path: []const u8) void {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:86
        const content: []const u8 = (std.fs.cwd().readFileAlloc(_allocator, path, std.math.maxInt(usize)) catch @panic("File.read error"));
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:87
        var line_no: i64 = 0;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:88
        var in_zebra: bool = false;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:92
        {
            var _it_raw = std.mem.splitSequence(u8, content, "\n");
            while (_it_raw.next()) |raw| {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:93
                line_no = (line_no + 1);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:94
                if (std.mem.startsWith(u8, raw, "```zebra")) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:95
                    in_zebra = true;
                    continue;
                }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:97
                if ((in_zebra and std.mem.startsWith(u8, raw, "```"))) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:98
                    in_zebra = false;
                    continue;
                }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:100
                if (in_zebra) {
                    self.scanLine(path, line_no, raw);
                }
            }
        }
    }
...
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:107
        var i: i64 = 0;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:108
        var in_str: bool = false;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:109
        const n = line.len;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:110
        while (_zebra_lt(i, n)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:111
            const c = line[@as(usize, @intCast(i))];
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:112
            if ((c == '"')) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:113
                in_str = (!in_str);
            } else {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:114
                if (((c == '#') and (!in_str))) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:115
                    return line[@as(usize, @intCast(0))..@as(usize, @intCast(i))];
                }
            }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:116
            i = (i + 1);
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:117
        return line;
    }

    pub fn scanLine(self: *Linter, file: []const u8, line_no: i64, line: []const u8) void {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:120
        if ((line.len == 0)) {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:121
            return;
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:122
        const stripped: []const u8 = Linter.stripComment(line);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:123
        const trimmed: []const u8 = std.mem.trim(u8, stripped, " \t\n\r");
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:125
        if ((std.mem.indexOf(u8, stripped, " inherits ") != null)) {
            self.findings.append(_allocator, Finding.init(file, line_no, "inherits", line)) catch @panic("OOM");
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:127
            return;
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:128
        if ((std.mem.indexOf(u8, stripped, "super.") != null)) {
            self.findings.append(_allocator, Finding.init(file, line_no, "super", line)) catch @panic("OOM");
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:130
            return;
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:131
        if (std.mem.startsWith(u8, trimmed, "prop ")) {
            self.findings.append(_allocator, Finding.init(file, line_no, "prop-keyword", line)) catch @panic("OOM");
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:133
            return;
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:134
        if (std.mem.eql(u8, trimmed, "shared")) {
            self.findings.append(_allocator, Finding.init(file, line_no, "shared-group", line)) catch @panic("OOM");
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:136
            return;
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:137
        if (std.mem.startsWith(u8, trimmed, "shared def ")) {
            self.findings.append(_allocator, Finding.init(file, line_no, "shared-inline", line)) catch @panic("OOM");
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:139
            return;
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:140
        if (std.mem.startsWith(u8, trimmed, "shared var ")) {
            self.findings.append(_allocator, Finding.init(file, line_no, "shared-inline", line)) catch @panic("OOM");
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:142
            return;
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:143
        if ((std.mem.startsWith(u8, trimmed, "var ") and (std.mem.indexOf(u8, trimmed, " as ") != null))) {
            self.findings.append(_allocator, Finding.init(file, line_no, "var-as", line)) catch @panic("OOM");
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:145
            return;
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:146
        if ((std.mem.startsWith(u8, trimmed, "def ") and (std.mem.indexOf(u8, trimmed, " as ") != null))) {
            self.findings.append(_allocator, Finding.init(file, line_no, "def-as", line)) catch @panic("OOM");
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:148
            return;
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:149
        if ((std.mem.startsWith(u8, trimmed, "cue init") and (std.mem.indexOf(u8, trimmed, " as ") != null))) {
            self.findings.append(_allocator, Finding.init(file, line_no, "cue-init-as", line)) catch @panic("OOM");
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:151
            return;
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:152
        if ((std.mem.indexOf(u8, stripped, " mixes ") != null)) {
            self.findings.append(_allocator, Finding.init(file, line_no, "mixes", line)) catch @panic("OOM");
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:154
            return;
        }
    }

};
const _ttag_Linter: u64 = _zbr_hash("Linter");
const _reflect_Linter_name: []const u8 = "Linter";
const _reflect_Linter_fields: []const []const u8 = &.{"findings"};
const _reflect_Linter_field_types: []const []const u8 = &.{"List(Finding)"};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:160
        var args = _arg_parse();
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:161
        const root_opt = args.positional(0);
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:162
        var root: []const u8 = ".";
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:163
        if (root_opt) |r| {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:164
            root = r;
        }
        std.debug.print("{s}\n", .{(std.fmt.allocPrint(_allocator, "[book_lint] scanning {s}...", .{root}) catch @panic("OOM"))});
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:168
        var walker = Walker.init();
        walker.collect(root);
        std.debug.print("{s}\n", .{(std.fmt.allocPrint(_allocator, "[book_lint] {} markdown files", .{@as(i64, @intCast(walker.files.items.len))}) catch @panic("OOM"))});
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:172
        var linter = Linter.init();
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:173
        for (walker.files.items) |f| {
            linter.lint(f);
        }
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:176
        for (linter.findings.items) |finding| {
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:180
            const f: []const u8 = finding.file;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:181
            const c: []const u8 = finding.category;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:182
            const text: []const u8 = finding.text;
// zbr:C:/Projects/zebra-language-book/zebra-tools/book_lint.zbr:183
            const trimmed: []const u8 = std.mem.trim(u8, text, " \t\n\r");
            std.debug.print("{s}\n", .{(std.fmt.allocPrint(_allocator, "{s}:{}: {s}: {s}", .{f, finding.line, c, trimmed}) catch @panic("OOM"))});
        }
        std.debug.print("{s}\n", .{"---"});
        std.debug.print("{s}\n", .{(std.fmt.allocPrint(_allocator, "[book_lint] {} findings", .{@as(i64, @intCast(linter.findings.items.len))}) catch @panic("OOM"))});
    }
...
fn _reflect_lookup_name(tag: u64) []const u8 {
    if (tag == _ttag_Finding) return _reflect_Finding_name;
    if (tag == _ttag_Walker) return _reflect_Walker_name;
    if (tag == _ttag_Linter) return _reflect_Linter_name;
    if (tag == _ttag_Main) return _reflect_Main_name;
    return "unknown";
}
fn _reflect_lookup_fields(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_Finding) return .{ .items = _reflect_Finding_fields };
    if (tag == _ttag_Walker) return .{ .items = _reflect_Walker_fields };
    if (tag == _ttag_Linter) return .{ .items = _reflect_Linter_fields };
    if (tag == _ttag_Main) return .{ .items = _reflect_Main_fields };
    return .{ .items = &.{} };
}
fn _reflect_lookup_field_types(tag: u64) _ReflectStrSlice {
    if (tag == _ttag_Finding) return .{ .items = _reflect_Finding_field_types };
    if (tag == _ttag_Walker) return .{ .items = _reflect_Walker_field_types };
    if (tag == _ttag_Linter) return .{ .items = _reflect_Linter_field_types };
